...
const AddNewClass = () => {
    ...
    const onSubmit = async(data) => {
        ...
        //   todo:entry class api path
          const trainerRes = await axiosSecure.post('/entryclass',trainerInfo);
          ...
          if(trainerRes.data.insertedId){
            ...
            Swal.fire({
              position: "top-end",
              icon: "success",
              title: "Trainer Added To The Classes Page",
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="flex gap-6">
           ...
           <div className="form-control">
            ...
            <button className="mt-4 px-6 py-3 bg-[#80f221] text-black rounded-full font-semibold flex items-center text-xl hover:shadow-[#7ff2219a] shadow-xl hover:bg-[#ffffff46] mx-auto">Added Class<FaArrowTrendUp  className="ml-2"/></button>
        </form>
        </div>
        </div>
    );
